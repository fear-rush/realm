...
# example: when i try to set the dock static to true and then i turn it off again, it still behave as dock static as true
# and i must turn it off using `defaults write com.apple.dock "static-only" -bool "false" && killall Dock`
